...
# def build_rate_extensions(config, merged):

#     rate_hdus = []

#     for i, eband in enumerate(config["EBANDS"]):

#         emin = eband[0]
#         emax = eband[1]

#         # =========================================================
#         # Build RATE table for this energy band
#         # =========================================================

#         rate_table = Table()

#         rate_table["TIME"]      = merged.TIME * u.s
#         rate_table["RATE"]      = merged.RATE[:, i] * (u.count / u.s)
#         rate_table["ERROR"]     = merged.ERR[:, i] * (u.count / u.s)

#         # Does it really make sense to preserve these two columns for the total energy range instead of individual eband?
...
#         # =========================================================
#         # Build RATE header for this energy band
#         # =========================================================
...
#         rate_hdr["TSTARTI"] = (
#             tstarti,
#             "integer part of start time"
#         )

#         rate_hdr["TSTARTF"] = (
#             tstartf,
#             "fractional part of start time"
#         )

#         rate_hdr["TSTOPI"] = (
#             tstopi,
#             "integer part of stop time"
#         )

#         rate_hdr["TSTOPF"] = (
#             tstopf,
#             "fractional part of stop time"
#         )

#         rate_hdr["DATE-OBS"] = (
#             utc_to_date(tstart, merged.MJDREF),
#             "TSTART in isot format"
#         )

#         rate_hdr["DATE-END"] = (
#             utc_to_date(tstop, merged.MJDREF),
#             "TSTOP in isot format"
#         )

#         rate_hdr["MJD-OBS"] = (
#             utc_to_mjd(tstart, merged.MJDREF),
#             "TSTART in MJD"
#         )

#         rate_hdr["MJD-END"] = (
#             utc_to_mjd(tstop, merged.MJDREF),
#             "TSTOP in MJD"
#         )

#         rate_hdr["CREATOR"] = (
#             "batbinevt",
#             "Tool that created this file (v 1.49)"
#         )
...
#         rate_hdr["TIMVERSN"] = (
#             "OGIP/93-003",
#             "Version of light curve format"
#         )

#         # =========================================================
#         # Energy range for THIS RATE extension
#         # =========================================================

#         rate_hdr["EMIN"] = (
#             emin,
#             "[keV] Lower energy bound"
#         )

#         rate_hdr["EMAX"] = (
#             emax,
#             "[keV] Upper energy bound"
#         )
...
#         rate_hdr["HDUCLAS1"] = (
#             "LIGHTCURVE",
#             "Contains light curve"
#         )

#         rate_hdr["HDUCLAS2"] = (
#             "NET",
#             "Light curve is background subtracted"
#         )

#         rate_hdr["HDUCLAS3"] = (
#             "RATE",
#             "Data values are RATE data"
#         )
...
#         rate_hdr["BACKAPP"] = (
#             "T",
#             "Was background correction applied?"
#         )
...
#         rate_hdu = fits.BinTableHDU(
#             rate_table,
#             header=rate_hdr,
#             name=extname
#         )

#         rate_hdus.append(rate_hdu)
